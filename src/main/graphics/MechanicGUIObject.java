...
public class MechanicGUIObject extends GUIObject{
   ...
   public void drawStuck(Point point, Graphics2D g){
           ...
           int point1X = (int) (point.x-5 + 20 * Math.cos(angleRadians));
           int point1Y = (int) (point.y-5 + 20 * Math.sin(angleRadians));

           int point2X = (int) (point.x-5 - 20 * Math.cos(angleRadians));
           int point2Y = (int) (point.y-5 - 20 * Math.sin(angleRadians));

           //Getting the second line's two ends
           int point3X = (int) (point.x-5 - 20 * Math.cos(angleRadians));
           int point3Y = (int) (point.y-5 + 20 * Math.sin(angleRadians));

           int point4X = (int) (point.x-5 + 20 * Math.cos(angleRadians));
           int point4Y = (int) (point.y-5 - 20 * Math.sin(angleRadians));
